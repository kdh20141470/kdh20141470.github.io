...
<head>
 ...
 <% String sName= request.getParameter("sNmae");
 out.println(" <input id='id12' class='class3' type='text' name='sName'siz='20' maxlength='50 value='"+sName+"'/>");%></div>
 ...
 <%=requst.getParameter("sPhone")%></div>
 <div id="div4">
